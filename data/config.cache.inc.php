...
$cfg_basehost = '';
$cfg_cmspath = '';
$cfg_cookie_encode = '3N5cOP9trUd6yx6CEvm9suK7WaGnX';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '现代简约响应式自适应家装设计类织梦模板';
...
$index_gsjj = ' allvery的本意为松果体，即隐藏于人类大脑深处的一个小核，虽然小，但它却主掌我们的感觉与冥想，在某些宗教理论中被称为人的第三只眼睛。正是这只“隐秘的”的天眼，一直带给人类无穷的想象力与创造力，推动我们的文明前进。<br>
“对未知神秘事物好奇”，是allvery一直所强调的。那些穿插于人类千年历史的宗教、战争、文化、种族、生物、灵异等都成为了构建allvery的重要元素，并通过不同形式体现在allvery的每一件单品中。你…	';
?>